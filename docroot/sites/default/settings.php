 ...
 *
 */
$drupal_hash_salt = 'MdTYDrEto4p-54SohoptDLgG8fklNOY6tpQLhy4l5JM';
 ...
 * for you.
 */
# $base_url = 'http://staging.fieldmuseum.org';  // NO trailing slash!
...
*
* See http://acquia.com/documentation/acquia-hosting/databases
*
* Acquia hosting also provides the following additional $_SERVER variables.
*
* AH_SITE_NAME: the AH site name (eg. fldmusestg).
* AH_SITE_GROUP: the AH site group = name of the parent site (eg. fldmuse).
* AH_SITE_ENVIRONMENT: the environment (aka. stage) of the site (dev, test, or prod).
