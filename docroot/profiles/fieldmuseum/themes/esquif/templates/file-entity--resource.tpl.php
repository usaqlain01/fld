...
<article id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <section class="resource__details">
    ...
    <h3<?php print $title_attributes; ?>><a class="resource__link" href="<?php print $file_url; ?>"><?php print render($content['media_title']); ?></a></h3>
    ...
    <?php endif; ?>
    <p<?php print $content_attributes; ?>>
      <?php
      // We hide the links now so that we can render them later.
      hide($content['links']);
      print check_markup(render($content), 'unfiltered_phrase_html', '', TRUE);
      ?>
    </p>
