...
$(function() {
  ...
  $(window).on("delayedResize", function() {
    if (window.outerWidth < mq.mobile) {
      $('body').removeClass(selector.body);
      $('body').removeClass(selector.bodyWide);
      stickyDetach("." + selector.item);
    } else if (window.outerWidth < mq.narrow) {
      if ($("." + selector.body).length === 0) {
        $('body').removeClass(selector.bodyWide);
        $('body').addClass(selector.body);
        stickIt("." + selector.item + ":not('." + selector.itemWide + "')", mq.mobile);
      }
      stickyDetach("." + selector.itemWide);
    } else {
      if ($("." + selector.bodyWide).length === 0) {
        $('body').removeClass(selector.body);
        $('body').addClass(selector.bodyWide);
        stickIt("." + selector.itemWide, mq.narrow);
        stickIt("." + selector.item, mq.mobile);
      }
    }
    return stickyRecalc();
  });
...
$(function() {
  ...
  $menuButton = "<button class='" + selector.menuLink + "'>" + text.menu + "</button>";
  return $("." + selector.menuTarget).prepend($menuButton).on("click", "." + selector.menuLink, function() {
