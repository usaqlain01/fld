...
$.fn.stick_in_parent = function(opts) {
  var elm, fn, i, inner_scrolling, len, offset_top, parent_selector, ref, sticky_class;
  if (opts == null) {
    opts = {};
  }
  ...
  ref = this;
  fn = function(elm, padding_bottom, parent_top, parent_height, top, height, el_float) {
    ...
    tick = function() {
      ...
      if (fixed) {
        ...
        if (scroll > top) {
          ...
          css.width = elm.css("box-sizing") === "border-box" ? elm.outerWidth() + "px" : elm.innerWidth + "px" || elm.width() + "px";
...
$(function() {
  ...
  selector = {
    body: "js--stickyBody",
    item: "js--sticky",
    parent: "js--stickyParent"
  };
  stickIt = function(el, breakpoint) {
  ...
  stickyDetach = function(el) {
    return $(el).trigger('sticky_kit:detach');
  };
  stickyRecalc = function() {
    return $(document.body).trigger("sticky_kit:recalc");
  };
  $(window).on("delayedResize", function() {
    if (window.outerWidth < mq.narrow) {
      if ($("." + selector.body).length === 1) {
        $('body').removeClass(selector.body);
        return stickyDetach("." + selector.item);
      }
    } else {
      if ($("." + selector.body).length === 0) {
        stickyDetach("." + selector.item);
        stickIt("." + selector.item, mq.narrow);
        $('body').addClass(selector.body);
        return stickyRecalc();
      }
    }
  });
...
$(function() {
  ...
  /*
  --------------------------------------------
       Begin selectMenu_loader.coffee
  --------------------------------------------
   */
// Generated by CoffeeScript 1.11.1
$(function() {
  var selector;
  selector = ".js--selectMenu";
  ...
  /*
  --------------------------------------------
       Begin smoothScroll.coffee
  --------------------------------------------
   */
// Generated by CoffeeScript 1.11.1
$(function() {
  return $('a[href*="#"]').smoothScroll({
    speed: 500,
    exclude: '.js--scrollExclude',
    afterScroll: function() {
      var targetHash;
      targetHash = $(this).attr('href');
      return window.location = targetHash;
    }
  });
});
  ...
  /*
  --------------------------------------------
       Begin responsiveMenu.coffee
  --------------------------------------------
   */
// Generated by CoffeeScript 1.11.1
$(function() {
  var $menuButton, $sectionMenuLink, selector, text;
  text = {
    mainMenu: "Menu",
    sectionMenu: "Jump to Section Navigation"
  };
  selector = {
    menu: "navMain",
    menuLink: "navMain__toggle",
    sectionMenu: "navSection",
    sectionMenuLink: "navSectionJump",
    sectionMenuId: "navSection",
    menuTarget: "navMain__brand",
    activeClass: "is--open"
  };
  $menuButton = "<button class='" + selector.menuLink + "'>" + text.mainMenu + "</button>";
  $sectionMenuLink = "<a href='#" + selector.sectionMenuId + "' class='" + selector.sectionMenuLink + "'>" + text.sectionMenu + "</a>";
  $("." + selector.menuTarget).prepend($menuButton).on("click", "." + selector.menuLink, function() {
    return $("." + selector.menu).toggleClass(selector.activeClass);
  });
  $("." + selector.sectionMenu).attr("id", selector.sectionMenuId);
  $(".l--body").prepend($sectionMenuLink);
  return $("." + selector.sectionMenuLink).smoothScroll({
    speed: 500,
    offset: -80
  });
});
  ...
  /*
  --------------------------------------------
       Begin responsiveContainer.coffee
  --------------------------------------------
   */
// Generated by CoffeeScript 1.11.1
$(function() {
  return $(".l--content").children("table").not(".google-cse-results table").wrap("<div class='is--overflow'></div>");
});

  /*
  --------------------------------------------
       Begin tickets.coffee
  --------------------------------------------
   */
// Generated by CoffeeScript 1.11.1
$(function() {
  return $(".tickets.is--visible--wide").on("click", ".js--toggleTickets", function() {
    return $(this).closest(".tickets").toggleClass("is--open");
  });
});
...
// Generated by CoffeeScript 1.11.1
$(function() {
  return $(".toggle .toggle__option").on("click", function() {
    return $(this).addClass("toggle__option--selected").siblings().removeClass("toggle__option--selected");
  });
});
...
// Generated by CoffeeScript 1.11.1
$(function() {
  return $(".search input").on("focus", function() {
    return $(".search").addClass("focus");
  }).on("blur", function() {
    return $(".search").removeClass("focus");
  });
});
