...
<div class="profile"<?php print $attributes; ?>>
  ...
  <?php hide($user_profile['field_givenname']); ?>
  <?php hide($user_profile['field_surname']); ?>
  <?php hide($user_profile['field_image']); ?>
  <?php hide($user_profile['field_position']); ?>
  <?php hide($user_profile['field_email']); ?>
  <?php hide($user_profile['field_dept_division_tags']); ?>
  <?php hide($user_profile['field_secondary_dept_division']); ?>
  <?php hide($user_profile['field_research_area_tags']); ?>
  <?php hide($user_profile['field_topic']); ?>
  <?php hide($user_profile['field_year_started']); ?>
  <?php hide($user_profile['field_introduction']); ?>
  <?php hide($user_profile['field_cvfile'])?>
