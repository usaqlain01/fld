...
<section class="personSummary <?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <figcaption class="person__details">
    <h3 class="person__name"<?php print $title_attributes; ?>>
      <?php if ($url): ?><a itemprop="url" href="<?php print $url; ?>"><?php endif; ?><?php print render($user_profile['field_givenname']); ?> <?php print render($user_profile['field_surname']); ?><?php if ($url): ?></a><?php endif; ?>
    </h3>
